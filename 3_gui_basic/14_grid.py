...
btn_f16.grid(row=0, column=0, sticky=N+E+W+S, padx=3, pady=3) #sticky는 그리드에 달라붙게(꽉차게)하는것
...
btn_enter.grid(row=4, column=3, rowspan=2, sticky=N+E+W+S, padx=3, pady=3) #rowspan은 row를 합치는 것 [현재위치에서 X만큼]
